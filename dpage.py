...
class Ui_Formd(QtWidgets.QWidget):
    ...
    def setupUi(self, Form):
        ...
        self.showp.setGeometry(QtCore.QRect(405, 323, 125, 50))
        ...
        self.frame.setGeometry(QtCore.QRect(-55, 280, 260, 131))
        ...
        self.cline.setGeometry(QtCore.QRect(123, 40, 130, 20))
        self.cline.setObjectName("cline")
        self.kline = QtWidgets.QLineEdit(parent=self.frame)
        self.kline.setGeometry(QtCore.QRect(123, 80, 130, 20))
    ...
    def decipher(self):
        ...
        self.showp.append(str(aes.decrypt(cy, key, 1)))
